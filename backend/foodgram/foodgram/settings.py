...
SECRET_KEY = 'django-insecure-o4kepv&%oq#uv7k4iwk=5liwe@qty79(kfrox6v5!5!@ipe_pi'
...
DJOSER = {
    'SERIALIZERS': {
        ...
        'user': 'api.serializers.UserSignUpSerializer',
        'current_user': 'api.serializers.UserSignUpSerializer',
    },
    'HIDE_USERS': False,
    'LOGIN_FIELD': 'email',
    'PERMISSIONS': {
